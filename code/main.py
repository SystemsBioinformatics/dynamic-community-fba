...
combined_model = combine_models([model1, model2], ["ecoli_1", "ecoli_2"])

joint_model = create_joint_fba_model(
    combined_model,
    ["R_BIOMASS_Ecoli_core_w_GAM", "R_BIOMASS_Ecoli_core_w_GAM_ecoli_2"],
)
model1 = combine_models([model1])
model1.createObjectiveFunction("R_BIOMASS_Ecoli_core_w_GAM")
km: KineticModel = KineticModel(model1, {})
